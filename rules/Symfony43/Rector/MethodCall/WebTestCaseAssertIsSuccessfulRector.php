...
final class WebTestCaseAssertIsSuccessfulRector extends AbstractRector implements DeprecatedInterface
{
    ...
    public function refactor(Node $node): ?Node
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" is deprecated, as it hides the asserted behavior and forces different assert methods for different status codes. Assert the HTTP status code directly instead',
            self::class
        ));
    }
