...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" is deprecated, as passing the form instead of "->createView()" is ambiguous and breaks dynamic forms. Keep the explicit "->createView()" call. See https://github.com/symfony/symfony/issues/50542',
            self::class
        ));
    }
}
