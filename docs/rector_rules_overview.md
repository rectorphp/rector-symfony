...
- [AddMessageToEqualsResponseCodeRector](#addmessagetoequalsresponsecoderector)
- [AddRouteAnnotationRector](#addrouteannotationrector)
- [AddViolationToBuildViolationRector](#addviolationtobuildviolationrector)
- [AuthorizationCheckerIsGrantedExtractorRector](#authorizationcheckerisgrantedextractorrector)
- [BinaryFileResponseCreateToNewInstanceRector](#binaryfileresponsecreatetonewinstancerector)
- [CascadeValidationFormBuilderRector](#cascadevalidationformbuilderrector)
- [ChangeCollectionTypeOptionNameFromTypeToEntryTypeRector](#changecollectiontypeoptionnamefromtypetoentrytyperector)
- [ChangeFileLoaderInExtensionAndKernelRector](#changefileloaderinextensionandkernelrector)
- [ChangeStringCollectionOptionToConstantRector](#changestringcollectionoptiontoconstantrector)
- [CommandConstantReturnCodeRector](#commandconstantreturncoderector)
- [CommandDescriptionToPropertyRector](#commanddescriptiontopropertyrector)
- [CommandPropertyToAttributeRector](#commandpropertytoattributerector)
- [ConsoleExceptionToErrorEventConstantRector](#consoleexceptiontoerroreventconstantrector)
- [ConsoleExecuteReturnIntRector](#consoleexecutereturnintrector)
- [ConstraintUrlOptionRector](#constrainturloptionrector)
- [ContainerBuilderCompileEnvArgumentRector](#containerbuildercompileenvargumentrector)
- [ContainerGetToConstructorInjectionRector](#containergettoconstructorinjectionrector)
- [DefinitionAliasSetPrivateToSetPublicRector](#definitionaliassetprivatetosetpublicrector)
- [EventListenerToEventSubscriberRector](#eventlistenertoeventsubscriberrector)
- [FormBuilderSetDataMapperRector](#formbuildersetdatamapperrector)
- [FormIsValidRector](#formisvalidrector)
- [FormTypeGetParentRector](#formtypegetparentrector)
- [FormTypeInstanceToClassConstRector](#formtypeinstancetoclassconstrector)
- [FormTypeWithDependencyToOptionsRector](#formtypewithdependencytooptionsrector)
- [GetHelperControllerToServiceRector](#gethelpercontrollertoservicerector)
- [GetParameterToConstructorInjectionRector](#getparametertoconstructorinjectionrector)
- [GetRequestRector](#getrequestrector)
- [GetToConstructorInjectionRector](#gettoconstructorinjectionrector)
- [InvokableControllerRector](#invokablecontrollerrector)
- [JMSInjectPropertyToConstructorInjectionRector](#jmsinjectpropertytoconstructorinjectionrector)
- [KernelTestCaseContainerPropertyDeprecationRector](#kerneltestcasecontainerpropertydeprecationrector)
- [LiteralGetToRequestClassConstantRector](#literalgettorequestclassconstantrector)
- [LoadValidatorMetadataToAnnotationRector](#loadvalidatormetadatatoannotationrector)
- [LogoutHandlerToLogoutEventSubscriberRector](#logouthandlertologouteventsubscriberrector)
- [LogoutSuccessHandlerToLogoutEventSubscriberRector](#logoutsuccesshandlertologouteventsubscriberrector)
- [MagicClosureTwigExtensionToNativeMethodsRector](#magicclosuretwigextensiontonativemethodsrector)
- [MakeCommandLazyRector](#makecommandlazyrector)
- [MakeDispatchFirstArgumentEventRector](#makedispatchfirstargumenteventrector)
- [MaxLengthSymfonyFormOptionToAttrRector](#maxlengthsymfonyformoptiontoattrrector)
- [MergeMethodAnnotationToRouteAnnotationRector](#mergemethodannotationtorouteannotationrector)
- [OptionNameRector](#optionnamerector)
- [ParamTypeFromRouteRequiredRegexRector](#paramtypefromrouterequiredregexrector)
- [ParseFileRector](#parsefilerector)
- [ProcessBuilderGetProcessRector](#processbuildergetprocessrector)
- [ProcessBuilderInstanceRector](#processbuilderinstancerector)
- [PropertyAccessorCreationBooleanToFlagsRector](#propertyaccessorcreationbooleantoflagsrector)
- [PropertyPathMapperToDataMapperRector](#propertypathmappertodatamapperrector)
- [ReadOnlyOptionToAttributeRector](#readonlyoptiontoattributerector)
- [RedirectToRouteRector](#redirecttorouterector)
- [ReflectionExtractorEnableMagicCallExtractorRector](#reflectionextractorenablemagiccallextractorrector)
- [RemoveDefaultGetBlockPrefixRector](#removedefaultgetblockprefixrector)
- [RemoveServiceFromSensioRouteRector](#removeservicefromsensiorouterector)
- [RemoveUnusedRequestParamRector](#removeunusedrequestparamrector)
- [RenderMethodParamToTypeDeclarationRector](#rendermethodparamtotypedeclarationrector)
- [ReplaceSensioRouteAnnotationWithSymfonyRector](#replacesensiorouteannotationwithsymfonyrector)
- [ReplaceServiceArgumentRector](#replaceserviceargumentrector)
- [ResponseReturnTypeControllerActionRector](#responsereturntypecontrolleractionrector)
- [ResponseStatusCodeRector](#responsestatuscoderector)
- [RootNodeTreeBuilderRector](#rootnodetreebuilderrector)
- [RouteCollectionBuilderToRoutingConfiguratorRector](#routecollectionbuildertoroutingconfiguratorrector)
- [ServiceSetStringNameToClassNameRector](#servicesetstringnametoclassnamerector)
- [SimpleFunctionAndFilterRector](#simplefunctionandfilterrector)
- [StringFormTypeToClassRector](#stringformtypetoclassrector)
- [StringToArrayArgumentProcessRector](#stringtoarrayargumentprocessrector)
- [SwiftCreateMessageToNewEmailRector](#swiftcreatemessagetonewemailrector)
- [SwiftSetBodyToHtmlPlainMethodCallRector](#swiftsetbodytohtmlplainmethodcallrector)
- [TemplateAnnotationToThisRenderRector](#templateannotationtothisrenderrector)
- [ValidatorBuilderEnableAnnotationMappingRector](#validatorbuilderenableannotationmappingrector)
- [VarDumperTestTraitMethodArgsRector](#vardumpertesttraitmethodargsrector)
- [WebTestCaseAssertIsSuccessfulRector](#webtestcaseassertissuccessfulrector)
- [WebTestCaseAssertResponseCodeRector](#webtestcaseassertresponsecoderector)
- [WebTestCaseAssertSelectorTextContainsRector](#webtestcaseassertselectortextcontainsrector)
