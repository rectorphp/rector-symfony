...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" is deprecated, as it renames the call to methods that only exist on a Symfony Mailer Email, while the object is still a Swift_Message. Migrate to Symfony Mailer manually instead.',
            self::class
        ));
    }
}
