...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" is deprecated, as it only guesses a part of the SwiftMailer to Symfony Mailer conversion and leaves the rest behind. Migrate to Symfony Mailer manually instead.',
            self::class
        ));
    }
}
