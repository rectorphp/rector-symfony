...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" is deprecated, as it guesses the template name from naming conventions and has to classify every return as template variables or a Response. Write a local custom rule for your own controllers instead.',
            self::class
        ));
    }
}
