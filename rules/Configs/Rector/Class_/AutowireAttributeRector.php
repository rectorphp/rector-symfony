...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Class_
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" is deprecated, as pairing constructor params with config arguments by name and position is far-fetched and not reliable. Handle custom autowiring with care, one service at a time',
            self::class
        ));
    }
}
