 ...
 */
final class ErrorNamesPropertyToConstantRector extends AbstractRector implements ComposerPackageConstraintInterface
{
    ...
    {
        return new ComposerPackageConstraint('symfony/validator', '>=6.1');
    }
