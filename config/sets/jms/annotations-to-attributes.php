...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->set(AnnotationToAttributeRector::class)
        ->configure([
            ...
            new AnnotationToAttribute('JMS\Serializer\Annotation\PostDeserialize'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\PostSerialize'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\PreSerialize'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\ReadOnly'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\ReadOnlyProperty'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\SerializedName'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\Since'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\SkipWhenEmpty'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\Type'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\Until'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\VirtualProperty'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\XmlAttributeMap'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\XmlAttribute'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\XmlDiscriminator'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\XmlElement'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\XmlKeyValuePairs'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\XmlList'),
            new AnnotationToAttribute('JMS\Serializer\Annotation\XmlMap'),
