...
final class ParameterBagToAutowireAttributeRector extends AbstractRector implements DeprecatedInterface
{
    ...
    public function refactor(Node $node): ?Node
    {
        throw new ShouldNotHappenException(sprintf(
            '"%s" is deprecated, as too specific and opinionated to maintain as a generic rule. Write a custom rule for your own ParameterBag-to-#[Autowire] convention instead',
            self::class
        ));
    }
