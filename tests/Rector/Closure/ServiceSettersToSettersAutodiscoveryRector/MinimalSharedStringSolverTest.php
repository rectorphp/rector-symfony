...
class MinimalSharedStringSolverTest extends TestCase
{
    ...
    static public function twoStringsSymmetricValuesProvider()
    {
        return [
            'Empty values'                          => [
                '',
    ...
    static public function twoStringsOrderedValuesProvider()
    {
        return [
    ...
    static public function threeStringsSymmetricValuesProvider()
    {
        return [
            'No match'          => [
                'ABDEGH',
